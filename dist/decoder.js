 ...
 *
 */
export function subStringToData(dataString, type, format) {
    let data;
    switch (type) {
        case 'BOOL':
        ...
        case 'EndStruct':
            ...
            break;
        default:
            log('TAME library error: Unknown data type at parsing read request: ' +
                type);
            break;
    }
    return data;
 ...
 * @param {String} string
 */
export function parsePlcLreal(string) {
 ...
 * @param {String} string
 */
export function parsePlcString(string) {
    /*
 ...
 * @param {String} string
 */
export function parsePlcReal(string) {
    let mant = 1;
 ...
 * @param {String} format
 */
export function parsePlcDate(string, format) {
 ...
 * @param {String} format
 */
export function parsePlcTod(string, format) {
 ...
 * @param {String} string
 */
export function parsePlcUsint(string) {
 ...
 * @param {String} string
 */
export function parsePlcSint(string) {
 ...
 * @param {String} string
 */
export function parsePlcUint(string) {
 ...
 * @param {String} string
 */
export function parsePlcInt(string) {
 ...
 * @param {String} string
 */
export function parsePlcDint(string) {
 ...
 * @param {String} format
 */
export function parsePlcTime(string, format) {
